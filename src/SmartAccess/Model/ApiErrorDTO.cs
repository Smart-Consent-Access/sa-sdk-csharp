...
namespace SmartAccess.Model
{
    ...
    public partial class ApiErrorDTO : IEquatable<ApiErrorDTO>, IValidatableObject
    {
        ...
        public ApiErrorDTO(double statusCode = default(double), string message = default(string))
        {
            this.StatusCode = statusCode;
            // to ensure "message" is required (not null)
            if (message == null) {
                throw new ArgumentNullException("message is a required property for ApiErrorDTO and cannot be null");
            }
