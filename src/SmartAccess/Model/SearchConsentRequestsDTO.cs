...
namespace SmartAccess.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SearchConsentRequestsDTO")]
    public partial class SearchConsentRequestsDTO : IEquatable<SearchConsentRequestsDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchConsentRequestsDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SearchConsentRequestsDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchConsentRequestsDTO" /> class.
        /// </summary>
        ...
        /// <param name="searchQuery">String to search for in consent requests. The following data will be searched to contain the string - Resources, actions, conditions and legal entity (id and name).  If the string matches any (OR) of these then its a search hit. An empty string matches all. Leave out to only apply the filters (fields).</param>
        /// <param name="fields">fields (required).</param>
        /// <param name="sort">sort.</param>
        public SearchConsentRequestsDTO(double skip = default(double), double take = default(double), string searchQuery = default(string), SearchConsentRequestsDTOFields fields = default(SearchConsentRequestsDTOFields), SearchConsentsDTOSort sort = default(SearchConsentsDTOSort))
        {
            // to ensure "fields" is required (not null)
            if (fields == null) {
                throw new ArgumentNullException("fields is a required property for SearchConsentRequestsDTO and cannot be null");
            }
            this.Fields = fields;
            this.Skip = skip;
            this.Take = take;
        ...
        /// </summary>
        /// <value>String to search for in consent requests. The following data will be searched to contain the string - Resources, actions, conditions and legal entity (id and name).  If the string matches any (OR) of these then its a search hit. An empty string matches all. Leave out to only apply the filters (fields)</value>
        ...
        public SearchConsentRequestsDTOFields Fields { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SearchConsentRequestsDTO {\n");
        ...
        {
            return this.Equals(input as SearchConsentRequestsDTO);
        }

        /// <summary>
        /// Returns true if SearchConsentRequestsDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of SearchConsentRequestsDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SearchConsentRequestsDTO input)
        {
            if (input == null)
                return false;
