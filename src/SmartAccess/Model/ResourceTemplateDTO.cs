...
namespace SmartAccess.Model
{
    ...
    /// ResourceTemplateDTO
    /// </summary>
    [DataContract(Name = "ResourceTemplateDTO")]
    public partial class ResourceTemplateDTO : IEquatable<ResourceTemplateDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceTemplateDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ResourceTemplateDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ResourceTemplateDTO" /> class.
        /// </summary>
        ...
        public ResourceTemplateDTO(string id = default(string), string policyActionTemplateId = default(string), string tenantName = default(string), string systemName = default(string), List<ResourceTagTemplateDTO> resourceTagTemplates = default(List<ResourceTagTemplateDTO>))
        {
            // to ensure "id" is required (not null)
            if (id == null) {
                throw new ArgumentNullException("id is a required property for ResourceTemplateDTO and cannot be null");
            }
            this.Id = id;
            // to ensure "policyActionTemplateId" is required (not null)
            if (policyActionTemplateId == null) {
                throw new ArgumentNullException("policyActionTemplateId is a required property for ResourceTemplateDTO and cannot be null");
            }
            this.PolicyActionTemplateId = policyActionTemplateId;
            // to ensure "tenantName" is required (not null)
            if (tenantName == null) {
                throw new ArgumentNullException("tenantName is a required property for ResourceTemplateDTO and cannot be null");
            }
            this.TenantName = tenantName;
            // to ensure "systemName" is required (not null)
            if (systemName == null) {
                throw new ArgumentNullException("systemName is a required property for ResourceTemplateDTO and cannot be null");
            }
            this.SystemName = systemName;
            // to ensure "resourceTagTemplates" is required (not null)
            if (resourceTagTemplates == null) {
                throw new ArgumentNullException("resourceTagTemplates is a required property for ResourceTemplateDTO and cannot be null");
            }
        ...
        public List<ResourceTagTemplateDTO> ResourceTagTemplates { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ResourceTemplateDTO {\n");
        ...
        {
            return this.Equals(input as ResourceTemplateDTO);
        }

        /// <summary>
        /// Returns true if ResourceTemplateDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of ResourceTemplateDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResourceTemplateDTO input)
        {
            if (input == null)
                return false;
