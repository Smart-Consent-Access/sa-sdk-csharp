...
namespace SmartAccess.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PaginationResultDTO_ConsentRequestSearchResultDTO_")]
    public partial class PaginationResultDTOConsentRequestSearchResultDTO : IEquatable<PaginationResultDTOConsentRequestSearchResultDTO>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationResultDTOConsentRequestSearchResultDTO" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaginationResultDTOConsentRequestSearchResultDTO() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginationResultDTOConsentRequestSearchResultDTO" /> class.
        /// </summary>
        ...
        public PaginationResultDTOConsentRequestSearchResultDTO(List<ConsentRequestSearchResultDTO> list = default(List<ConsentRequestSearchResultDTO>), double totalCount = default(double), double taken = default(double))
        {
            // to ensure "list" is required (not null)
            if (list == null) {
                throw new ArgumentNullException("list is a required property for PaginationResultDTOConsentRequestSearchResultDTO and cannot be null");
            }
            this.List = list;
        ...
        public List<ConsentRequestSearchResultDTO> List { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginationResultDTOConsentRequestSearchResultDTO {\n");
        ...
        {
            return this.Equals(input as PaginationResultDTOConsentRequestSearchResultDTO);
        }

        /// <summary>
        /// Returns true if PaginationResultDTOConsentRequestSearchResultDTO instances are equal
        /// </summary>
        /// <param name="input">Instance of PaginationResultDTOConsentRequestSearchResultDTO to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginationResultDTOConsentRequestSearchResultDTO input)
        {
            if (input == null)
                return false;
